...
const QMetaObject CVideoThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_CVideoThread.data,
      qt_meta_data_CVideoThread,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CVideoThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CVideoThread.stringdata0))
        return static_cast<void*>(const_cast< CVideoThread*>(this));
